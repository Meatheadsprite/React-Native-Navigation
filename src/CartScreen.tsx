          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={styles.item}>
                {/* Product Image */}
                <Image
                  source={item.product.image} // Ensure this is correctly defined
...
const styles = StyleSheet.create({
  ...
  removeButton: {
    backgroundColor: '#ff4444', // Keep red for remove button
    borderRadius: 8,
    paddingVertical: 6,
  ...
  disabledButton: {
    backgroundColor: '#ccc', // Keep gray for disabled state
  },
  buttonText: {
    color: '#fff',
    fontSize: 16,
